...
public class CardData {
    ...
    public static final int CARD_SEQ_ALLISON = 0 ;
    public static final int CARD_SEQ_ALVIN = 1 ;
    ...
    public static final int CARD_SEQ_JAE = 9;
    ...
    public static final int CARD_SEQ_SUFEI = 22;
